...
class AdminNewOrderEmail implements ShouldQueue
{
    ...
    public function handle(PaymentSuccessNotify $event): void
    {
        ...
        $notification_email = Formatter::email(config('app.company.email'));
        ...
        if (!empty($notification_email)) {
            ...
            $request->put('order_number', $order_number);
            ...
            Mail::to($notification_email)->send(new OrderCreated($request));
        }
    }
}
