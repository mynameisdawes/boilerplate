...
/**
 * @method static \Vektor\Shop\Cart              instance(?string $instance)
 ...
 * @method static \Vektor\Shop\CartItem          get(string $rowId)
 * @method static \Vektor\Shop\CartItem          addCartItem(\Vektor\Shop\CartItem $item, bool $keepDiscount, bool $keepTax, bool $dispatchEvent)
 * @method static \Vektor\Shop\CartItem          add(mixed $id, mixed $name, float|int $qty, float $price, float $weight, array $options)
 * @method static \Vektor\Shop\CartItem          update(string $rowId, mixed $qty)
